...
def getSpectogram(file_path, emotion_label):
    ...
    output_image_path = f"./images4500/{emotion_label}/{processed_path}.png"  # TODO: figure out naming conventions for the file -- either use path or just have a counter that we pass in
...
df.to_csv('data4500.csv', index=False)